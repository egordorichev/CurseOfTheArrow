function love.conf(t)
  t.identity = "CurseOfTheArrow-2.0"  -- The name of the save directory (string)
  ...
  t.window.title = "Curse of the Arrow v2.0 development preview"  -- The window title (string)
