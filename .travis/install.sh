...
wget -O "../BuildUtils/CurseOfTheArrow-macos.zip" "https://github.com/RexcellentGames/CurseOfTheArrow-Binaries/releases/download/"$BINVER"/CurseOfTheArrow-macos.zip"
