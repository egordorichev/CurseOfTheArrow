...
7z A -r -y -tzip -bd Builds/CurseOfTheArrow-win32.zip win32/*
...
7z A -r -y -tzip -bd Builds/CurseOfTheArrow-win64.zip win64/*
...
7z A -r -y -tzip -bd Builds/CurseOfTheArrow-linux-x86_64.zip linux-x86_64/*
...
7z A -r -y -tzip -bd Builds/CurseOfTheArrow-linux-i686.zip linux-i686/*
